...
static Protocol supported_protocols[NUM_PROTOCOLS] = {
    ...
    {"Mitsubishi MUT", 9600, "\xA1\xB2", 2, 8, 1, 0},
    {"Hyundai/Kia HDS", 9600, "\xC1\xD2", 2, 8, 1, 0},
    {"GM OBD-I (8192 Baud, Alternate)", 8192, "\xF4\x57\xF4\x57", 4, 8, 1, 0}
};
